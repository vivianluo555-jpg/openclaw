...
const content = {
  en: {
    ...
    footerDesc:
      "The world's leading viral video content library. We help creators crack the viral code through deep analysis and AI technology.",
    footerResources: "Resources",
    footerLatest: "Latest Viral Cases",
    footerIPLib: "IP Category Library",
    footerAIGuide: "AI Prompt Guide",
    footerSupport: "Contact & Support",
    footerAbout: "About Us",
    footerBiz: "Business Inquiries",
    footerCommunity: "Join Community",
    footerCopyright:
      "© 2024 HotVault. All rights reserved. Empowering every creator to crack the viral code.",
    footerPrivacy: "Privacy Policy",
    footerTerms: "Terms of Service",
  },
  zh: {
    navAbout: "关于爆款库",
    navMethodology: "拆解方法论",
    navEnter: "进入爆款库",
    badge: "全球领先的内容爆款库",
    heroDesc1: (
      <>
    ...
    ctaCta: "立即免费开启爆款库",
    footerDesc:
      "全球领先的视频内容爆款库。我们通过深度拆解和 AI 技术，助力创作者捕捉流量密码，打造属于自己的千万级播放爆款。",
    footerResources: "爆款库资源",
    footerLatest: "最新爆款案例",
    footerIPLib: "IP 分类库",
    footerAIGuide: "AI 提示词指南",
    footerSupport: "联系与支持",
    footerAbout: "关于我们",
    footerBiz: "商务合作",
    footerCommunity: "加入社区",
    footerCopyright:
      "© 2024 HotVault 爆款库. 版权所有。助力每一位创作者捕捉流量密码。",
    footerPrivacy: "隐私政策",
    footerTerms: "服务条款",
  },
};

export default function HotVaultLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-black selection:text-white">
      ...
      {/* Footer */}
      <footer className="px-8 py-20 border-t border-black/5 bg-white">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            <h4 className="font-bold mb-6 uppercase tracking-widest text-xs text-black/40">
              {t.footerResources}
            </h4>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-12 border-t border-black/5 text-xs text-black/30 font-medium">
