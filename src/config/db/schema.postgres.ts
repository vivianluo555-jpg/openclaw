...
export const video = table(
  'video',
  {
    ...
    contentCategory: text('content_category'), // e.g., 'format', 'story'
    ipCategory: text('ip_category'), // e.g., 'kpop', 'celebrity', 'naruto'
    styleCategory: text('style_category'), // e.g., 'live_action', 'animation'
